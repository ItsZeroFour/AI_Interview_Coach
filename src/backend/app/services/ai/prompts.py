...
Верни ТОЛЬКО текст вопроса на русском языке, без нумерации и пояснений."""
...
## Задание:
Оцени ответ кандидата. Верни результат строго в JSON:
...
## Задание:
Сформируй итоговый отчёт по собеседованию. Верни строго JSON:
...
{{
  ...
  "summary": "общий вывод о кандидате на русском (3-4 предложения)",
